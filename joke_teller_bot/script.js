...
// Passing joke variable to voiceAPI
function tellMe(joke) {
    console.log('tell me:', joke)
    VoiceRSS.speech({
        key: '6311d3df3023487c8cfc594820e4f020',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = ''
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Any?blacklistFlags=nsfw,religious,political,racist,sexist,explicit'
    try{
